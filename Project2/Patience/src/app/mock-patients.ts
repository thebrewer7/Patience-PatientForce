...
export const PATIENTS: Patient[] = [
    {id: 1, name: 'Logan', role: 'Patient', location: '1st floor', status: 'moving', condition: 'undetermined', preferredDoctor: 'Ray', nurses: [
        {id: 1, name: 'Nurse1', role: 'Nurse', certifications: [], rating: 5, reviews: [], department: '1', doctors: [], locked: false },
        {id: 2, name: 'Nurse2', role: 'Nurse', certifications: [], rating: 1, reviews: [], department: '1', doctors: [], locked: false }
    ], doctors: [
    ...
    {id: 2, name: 'Andrew', role: 'Patient', location: '2nd floor', status: 'sitting', condition: 'good', preferredDoctor: 'Ray', nurses: [
        {id: 3, name: 'Nurse3', role: 'Nurse', certifications: [], rating: 3, reviews: [], department: '1', doctors: [], locked: false },
        {id: 4, name: 'Nurse4', role: 'Nurse', certifications: [], rating: 4, reviews: [], department: '1', doctors: [], locked: false },
    ], doctors: [
    ...
    {id: 3, name: 'Ray', role: 'Patient', location: '3rd floor', status: 'climbing', condition: 'fair', preferredDoctor: 'Ray', nurses: [
        {id: 5, name: 'Nurse5', role: 'Nurse', certifications: [], rating: 2, reviews: [], department: '1', doctors: [], locked: false },
        {id: 6, name: 'Nurse6', role: 'Nurse', certifications: [], rating: 5, reviews: [], department: '1', doctors: [], locked: false },
    ], doctors: [
    ...
    {id: 4, name: 'Austin', role: 'Patient', location: '4th floor', status: 'running', condition: 'serious', preferredDoctor: 'Ray', nurses: [
        {id: 7, name: 'Nurse7', role: 'Nurse', certifications: [], rating: 1, reviews: [], department: '1', doctors: [], locked: false },
        {id: 8, name: 'Nurse8', role: 'Nurse', certifications: [], rating: 3, reviews: [], department: '1', doctors: [], locked: false },
    ], doctors: [
    ...
    {id: 5, name: 'Bobbert', role: 'Patient', location: '5th floor', status: 'walking', condition: 'critical', preferredDoctor: 'Ray', nurses: [
        {id: 9, name: 'Nurse9', role: 'Nurse', certifications: [], rating: 4, reviews: [], department: '1', doctors: [], locked: false },
        {id: 10, name: 'Nurse10', role: 'Nurse', certifications: [], rating: 2, reviews: [], department: '1', doctors: [], locked: false }
    ], doctors: [

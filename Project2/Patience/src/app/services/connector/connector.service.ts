...
export class ConnectorService {
  ...
  submitReviewByName(rating, review, role, date, id) {
    ...
    return this.http.get("http://http://18.205.153.39:8085/PatienceMavenProject/SubmitReview.do", { responseType: 'text', params: params });
  }
  ...
  getReviewByName(id, role) {
    ...
    return this.http.get<Review[]>("http://http://18.205.153.39:8085/PatienceMavenProject/GetReviews.do", { params: params });
  }
}
